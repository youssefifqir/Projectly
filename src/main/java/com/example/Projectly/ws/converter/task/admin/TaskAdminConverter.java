package com.example.Projectly.ws.converter.task.admin;
...
/**
 * Converter for Task entity - Admin view.
 * Access: ADMIN, MANAGER
 */
@Component
public class TaskAdminConverter {

    public TaskAdminDto toDto(Task entity) {
        if (entity == null) return null;
        TaskAdminDto dto = new TaskAdminDto();
